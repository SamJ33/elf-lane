  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-[#071f1a] to-[#031412] text-white px-4 py-10">
      ...
      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
        <h1 className="text-center text-3xl font-serif text-red-500">
          Secret Santa Day 1–7
        </h1>
      </motion.div>

      <Card className="mt-8 bg-[#0b2d26]/80 border border-[#184a3f] rounded-2xl shadow-xl">
        <CardContent className="p-6">
          <h2 id="santa-label" className="text-xl font-semibold mb-1">Who is your Santa?</h2>

          <select
            aria-labelledby="santa-label"
          ...
          <Slider
            value={[confidence]}
            onValueChange={(v: number[]) => setConfidence(v[0])}
            max={100}
            step={1}
          />
        </CardContent>
